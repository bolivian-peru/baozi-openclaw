...
const ClaimAgent_1 = require("../src/ClaimAgent");
...
async function runOmegaTest() {
    ...
    const owner = new web3_js_1.PublicKey('8hswmw8fVwErtwgZ6Y85dMR4L2Tytdpk54Jf9fmpKxHs');
    const market = new web3_js_1.PublicKey('So11111111111111111111111111111111111111112');
    ...
    const monitor = new ClaimAgent_1.BaoziMonitor('http://localhost', '11111111111111111111111111111111', owner.toBase58());
    // 3. Inject Data into Decoder (Private method access via 'any' casting for testing)
    const fakeAccountInfo = {
        data: buffer,
        executable: false,
        lamports: 0,
        owner: new web3_js_1.PublicKey('Baozi11111111111111111111111111111111111111'),
        rentEpoch: 0
    };
    const decoded = monitor.decodeUserPosition(new web3_js_1.PublicKey('11111111111111111111111111111111'), fakeAccountInfo);
