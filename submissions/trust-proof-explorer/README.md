...
python agent.py --tier 1    # Trustless (Pyth oracle, no human)
python agent.py --tier 2    # Verified (official API source)
python agent.py --tier 3    # AI Research (Grandma Mei AI)

# Filter by category (case-insensitive contains match)
python agent.py --category Sports
python agent.py --category politics

# Filter by layer
python agent.py --layer official
python agent.py --layer labs

# Search market questions
python agent.py --search "BTC"
python agent.py --search "Toyota"
...
# Combine filters
python agent.py --layer labs --category sports
python agent.py --tier 2 --search "Super Bowl" --compare
```
...
<!-- Screenshots of terminal output go here -->
